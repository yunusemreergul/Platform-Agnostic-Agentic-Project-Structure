...
Projenin anlık genel durumunu, aktif çalışmaları ve bilinen kısıtları tutan paylaşılan durum dosyasıdır. Tüm agent'lar okur; görev durumu veya proje genelinde bir şey değiştiğinde ilgili agent günceller. Her güncellemede `## Son Güncelleme` bölümü önce yenilenir.
